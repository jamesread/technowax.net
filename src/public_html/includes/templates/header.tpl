...
<head>
	...
	<title>technowax.net &bull; {$pageTitle|default:'Self-hosting utilities and community.'}</title>
...
<body>
	...
	<header>
		<p class = "headerLogo">
			<a href = "/"><img id = "headerLogo" src = "/resources/images/technowax.png" alt = "technowax.net" title = "technowax.net" /></a>
		</p>
